...
class MatchGame extends Component {
  ...
  onClickThumbnail = thumbnailUrl => {
    ...
    if (imageUrl === imgUrl) {
      ...
      const newImageUrl = imagesList[randomNumber].imageUrl
  ...
  render() {
    const {score, selectedTab, timer, imgUrl, isGameOver} = this.state
    ...
    return (
      <div className="bg-container">
        ...
        {!isGameOver && (
          <>
            <img src={imgUrl} className="random-image" alt="match" />
            ...
            <ul className="thumbnails-container">
              {imagesList.map(eachImage => {
                if (eachImage.category === selectedTab) {
                  return (
                    <li key={eachImage.id}>
                      <button
                        ...
                        type="button"
                        onClick={() =>
                          this.onClickThumbnail(eachImage.thumbnailUrl)
                        }
                      >
                        <img
